...
<link href="adminpage/vendor/fontawesome-free/css/all.min.css" rel="stylesheet"
	type="text/css">
<link
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800">Sách</h1>
					...
					<div class="card shadow mb-4">
						<div class="card-body">
							<div class="table-responsive" style="overflow-x: visible;">
										...
										<tbody>
											<c:forEach items="${listP}" var="o">
												<tr>
													...
													<td>${o.price}</td>
													<td>${o.soLuong}</td>
													<td style="letter-spacing: 5px;"><a href="AdminEditProduct?pid=${o.maSach }"> <svg
																style="width: 16px;" xmlns="http://www.w3.org/2000/svg"
																viewBox="0 0 512 512">
													...
													</a> <a href="deleteProduct?MaSach=${o.maSach}"> <svg style="width: 16px;"
								...
								<div class="row">
									<a href="adminpage/addProduct.jsp" class="btn btn-primary"> <span class="text text-white">
											Add </span>
									</a>
								</div>
							</div>
