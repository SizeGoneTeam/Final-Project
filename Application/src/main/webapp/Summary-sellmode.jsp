      ...
      <div class="grid__group">
        <div class="grid__cell grid__cell--3of16 m-page-left">
          <section class="m-links-accordion">
            <ul>
              <li class="selected"><a href="SummarysellsideControl">Tóm tắt</a></li>
              <li><a href="SellingControl">Đang bán</a></li>
            ...
            <div class="m-river__body">
             <div class="m-container__header border-header">
                  <div class="title-container">
                    <h2 class="title large-text-2">Tổng số sách đã đăng: ${sachdadangLong}</h2>
                ...
                <div class="m-container__header border-header">
                  <div class="title-container">
                    <h2 class="title large-text-2">Tổng số tiền đã bán: ${tongdoanhthu}</h2>
                    <div class="sub-title regular-text"></div>
                  </div>
                </div>
