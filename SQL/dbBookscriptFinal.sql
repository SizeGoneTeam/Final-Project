...
insert into tbSach(TenSach,Anh,DonGia,SoLuong,MoTa)
values
-- Sách văn học
	("Xứ Cát","https://salt.tikicdn.com/cache/750x750/ts/product/b4/f0/81/5d5e4a26cb029fdecd04e0c30cbef17a.jpg.webp",249000,10,"Sơ lược về tác phẩm
...
Là một trong những cuốn tiểu thuyết khoa học giả tưởng bán chạy nhất mọi thời đại, Xứ Cát không chỉ là lựa chọn đối với những tín đồ của Chúa nhẫn, Chiến tranh giữa các vì sao… mà còn chinh phục độc giả đủ mọi lứa tuổi, mọi tầng lớp và sở thích bởi sự đa dạng và phức tạp của con người và không gian trong truyện, bởi sự tinh tế trong xây dựng tâm lý, bởi sự hấp dẫn, căng thẳng và bất ngờ của cốt truyện, bởi sự độc đáo và thú vị của khối lượng kiến thức khổng lồ cũng như bởi sự hấp dẫn trong những tư tưởng về tôn giáo, về tự do, về tình yêu, về sự sống và cái chết…"),
    ("Nhà Giả Kim (Tái Bản 2020)","https://salt.tikicdn.com/cache/750x750/ts/product/45/3b/fc/aa81d0a534b45706ae1eee1e344e80d9.jpg.webp",79000,10,"Sơ lược về tác phẩm
...
“Nhưng nhà luyện kim đan không quan tâm mấy đến những điều ấy. Ông đã từng thấy nhiều người đến rồi đi, trong khi ốc đảo và sa mạc vẫn là ốc đảo và sa mạc. Ông đã thấy vua chúa và kẻ ăn xin đi qua biển cát này, cái biển cát thường xuyên thay hình đổi dạng vì gió thổi nhưng vẫn mãi mãi là biển cát mà ông đã biết từ thuở nhỏ. Tuy vậy, tự đáy lòng mình, ông không thể không cảm thấy vui trước hạnh phúc của mỗi người lữ khách, sau bao ngày chỉ có cát vàng với trời xanh nay được thấy chà là xanh tươi hiện ra trước mắt. ‘Có thể Thượng đế tạo ra sa mạc chỉ để cho con người biết quý trọng cây chà là,’ ông nghĩ.”"),
    ("Lolita (Tái Bản 2019)","https://salt.tikicdn.com/cache/750x750/ts/product/4f/f1/1c/ceef76f6047793edc7bc122c3138189a.jpg.webp",128000,10,"“Lolita, ánh sáng của đời tôi, ngọn lửa nơi hạ bộ của tôi. Tội lỗi của tôi, tâm hồn của tôi. Lo-lee-ta: đầu lưỡi lướt xuống ba bước nhỏ dọc vòm miệng, khẽ đập vào răng ba tiếng. Lo. Li. Ta.
...
Cuốn sách mở đầu cho mùa hè với minh họa dễ thương, hài hước là món quà dành cho mọi trẻ em và người lớn.'),
    ("Hoàng Tử Bé (Tái Bản 2019)","https://salt.tikicdn.com/cache/750x750/ts/product/5c/e7/68/26838e18d7f96d562d828980520019d2.jpg.webp",75000,10,'Hoàng tử bé được viết ở New York trong những ngày tác giả sống lưu vong và được xuất bản lần đầu tiên tại New York vào năm 1943, rồi đến năm 1946 mới được xuất bản tại Pháp. Không nghi ngờ gì, đây là tác phẩm nổi tiếng nhất, được đọc nhiều nhất và cũng được yêu mến nhất của Saint-Exupéry. Cuốn sách được bình chọn là tác phẩm hay nhất thế kỉ 20 ở Pháp, đồng thời cũng là cuốn sách Pháp được dịch và được đọc nhiều nhất trên thế giới. Với 250 ngôn ngữ dịch khác nhau kể cả phương ngữ cùng hơn 200 triệu bản in trên toàn thế giới, Hoàng tử bé được coi là một trong những tác phẩm bán chạy nhất của nhân loại.
...
insert into tbAccount(TK,MK,isAdmin)
values ("hai","hai123",1);
insert into tbAccount(TK,MK,isAdmin)
values ("a","b",0);

insert into `sql6521250`.`tbHoaDon` (`MaHD`, `MaKH`) VALUES ('1', '1');
INSERT INTO `sql6521250`.`tbHoaDon` (`MaHD`, `MaKH`) VALUES ('2', '1');
INSERT INTO `sql6521250`.`tbHoaDon` (`MaHD`, `MaKH`) VALUES ('3', '1');


INSERT INTO `sql6521250`.`tbChiTietHD` (`MaHD`, `MaSach`, `SoLuong`) VALUES ('1', '1', '2');
INSERT INTO `sql6521250`.`tbChiTietHD` (`MaHD`, `MaSach`, `SoLuong`) VALUES ('1', '2', '1');
INSERT INTO `sql6521250`.`tbChiTietHD` (`MaHD`, `MaSach`, `SoLuong`) VALUES ('1', '3', '1');
INSERT INTO `sql6521250`.`tbChiTietHD` (`MaHD`, `MaSach`, `SoLuong`) VALUES ('2', '5', '1');
INSERT INTO `sql6521250`.`tbChiTietHD` (`MaHD`, `MaSach`, `SoLuong`) VALUES ('2', '6', '3');
INSERT INTO `sql6521250`.`tbChiTietHD` (`MaHD`, `MaSach`, `SoLuong`) VALUES ('3', '8', '1');
INSERT INTO `sql6521250`.`tbChiTietHD` (`MaHD`, `MaSach`, `SoLuong`) VALUES ('3', '7', '1');
INSERT INTO `sql6521250`.`tbChiTietHD` (`MaHD`, `MaSach`, `SoLuong`) VALUES ('3', '5', '5');

INSERT INTO `sql6521250`.`tbRated` (`MaKH`, `MaSach`, `Rated`) VALUES ('1', '1', '5');
INSERT INTO `sql6521250`.`tbRated` (`MaKH`, `MaSach`, `Rated`) VALUES ('2', '1', '3');
INSERT INTO `sql6521250`.`tbRated` (`MaKH`, `MaSach`, `Rated`) VALUES ('1', '3', '1');
INSERT INTO `sql6521250`.`tbRated` (`MaKH`, `MaSach`, `Rated`) VALUES ('2', '3', '3');
